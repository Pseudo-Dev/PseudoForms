				...
				<div id="hero" className="home" style = {homeStyle}>
				    <div className="container">
				      <div className="hero-content">
						    <img src = { logo } className="img-responsive" id="logoSet"/>
					        <h1>
						        <div id = "typing" >
							        <span>
								        <Typed
	                		...
	                		<tr className="mt-4">
	                			<td className="p-3 "><button className = "btn btn-default btn-block btn-primary">Get Started</button></td>
	                			<td className="p-3 "><a href="#about"><button className = "btn btn-default btn-block btn-primary">Why PseudoForms</button></a></td>
	                		</tr>
				      </div>
				    </div>
				  </div>
			        ...
			        <div class="row justify-content-between">
			          ...
			          <div class="col-lg-7">
			            <div class="about-descr">
			              <p class="p-heading">Create amazing forms with, PseudoForms!</p>
